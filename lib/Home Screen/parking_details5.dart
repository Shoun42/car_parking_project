...
import 'billing_information6.dart'; // ✅ নতুন পেজ ইমপোর্ট

class ParkingDetails5 extends StatefulWidget {
  const ParkingDetails5({super.key});

  @override
  State<ParkingDetails5> createState() => _HomePageFiveState();
}

class _HomePageFiveState extends State<ParkingDetails5> {
  // --- THEME COLORS ---
        ...
        child: Container(
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                // ✅ Continue চাপলে BillingInformation6 পেজে যাবে
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const BillingInformation6()),
                );
              },
      ...
      child: Column(
        ...
        children: [
          ...
          _reviewTile(
            ...
            text:
            "Clean and safe parking area. Easy to reserve online. Will use again!",
          ),
